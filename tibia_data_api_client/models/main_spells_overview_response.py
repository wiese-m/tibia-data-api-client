...
if TYPE_CHECKING:
    ...
    from ..models.main_spells import MainSpells


T = TypeVar("T", bound="MainSpellsOverviewResponse")
...
class MainSpellsOverviewResponse:
    ...
    Attributes:
        ...
        spells (Union[Unset, MainSpells]):
    """

    information: Union[Unset, "MainInformation"] = UNSET
    spells: Union[Unset, "MainSpells"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_spells, Unset):
            ...
            spells = MainSpells.from_dict(_spells)

        main_spells_overview_response = cls(
            information=information,
            spells=spells,
        )

        main_spells_overview_response.additional_properties = d
        return main_spells_overview_response
