...
if TYPE_CHECKING:
    from ..models.main_guilds import MainGuilds
    from ..models.main_information import MainInformation


T = TypeVar("T", bound="MainGuildResponse")
...
class MainGuildResponse:
    """
    Attributes:
        guilds (Union[Unset, MainGuilds]):
        information (Union[Unset, MainInformation]):
    """

    guilds: Union[Unset, "MainGuilds"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_guilds, Unset):
            ...
            guilds = MainGuilds.from_dict(_guilds)
        ...
        main_guild_response = cls(
            guilds=guilds,
            information=information,
        )

        main_guild_response.additional_properties = d
        return main_guild_response
