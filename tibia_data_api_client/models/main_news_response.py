...
if TYPE_CHECKING:
    ...
    from ..models.main_news import MainNews


T = TypeVar("T", bound="MainNewsResponse")
...
class MainNewsResponse:
    ...
    Attributes:
        ...
        news (Union[Unset, MainNews]):
    """

    information: Union[Unset, "MainInformation"] = UNSET
    news: Union[Unset, "MainNews"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_news, Unset):
            ...
            news = MainNews.from_dict(_news)

        main_news_response = cls(
            information=information,
            news=news,
        )

        main_news_response.additional_properties = d
        return main_news_response
